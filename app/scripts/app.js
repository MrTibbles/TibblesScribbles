define(['jquery', 'underscore', 'backbone', 'models/vehicle-model', 'views/vehicle-view', 'collections/exterior-collection', 'views/exteriors-view', 'collections/interior-collection', 'views/interiors-view', 'collections/video-collection', 'views/videos-view', 'loader'], function($, _, Backbone, vehicles, vehicles_view, exterior_imgs, exteriors_view, interior_imgs, interiors_view, videos, videos_view, loader) {
  var app_view = Backbone.View.extend({
    el: $('#gallery-wrap'),
    events: {
      'click .ng-gallery-nav #exteriors': 'display_exteriors',
      'click .ng-gallery-nav #interiors': 'display_interiors',
      'click .ng-gallery-nav #videos': 'display_videos',
      'click .ng-gallery-nav #three-six': 'display_spins',
    ...
    render: function(type) {
      ...
      switch(type) {
        case 'spinner':
          ...
          this.$('.ng-gallery-nav li').removeClass('active_pane');
          this.$('.ng-gallery-nav li').eq(0).addClass('active_pane');
        ...
        case 'exterior':
          ...
          this.$('.ng-gallery-nav li').removeClass('active_pane');
          this.$('.ng-gallery-nav li').eq(1).addClass('active_pane');
        ...
        case 'interior':
          ...
          this.$('.ng-gallery-nav li').removeClass('active_pane');
          this.$('.ng-gallery-nav li').eq(2).addClass('active_pane');
        ...
        case 'video':
          ...
          this.$('.ng-gallery-nav li').removeClass('active_pane');
          this.$('.ng-gallery-nav li').eq(3).addClass('active_pane');
    ...
    load_collections: function(type) {
      ...
      this.videos.fetch();
      // setTimeout(function(){
      //   window.console && console.info(_this.videos.length)
      //   if(!_this.videos.length){
      //     _this.$('#videos').addClass('deactivated_pane');
      //   }
      // }, 750)
    ...
    display_exteriors: function(view_type) {
      ...
      if(this.exteriors.length === 0){
        ...
        this.viewport.html('<h1 id="no_content">Sorry, there are no images available.</h1>')
      }else{
    ...
    display_spins: function(view_type) {
      ...
      window.console && console.info(this.vehicles)
