...
export const SET_SIDEBAR_VISIBILITY_FILTER = 'SET_SIDEBAR_VISIBILITY_FILTER';
export const SIDEBAR_FILTER_HEADERS = {
	SHOW_ASSET_TYPES: 'SHOW_ASSET_TYPES',
	SHOW_CREATOR_OPTIONS: 'SHOW_CREATOR_OPTIONS',
