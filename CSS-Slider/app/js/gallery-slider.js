...
var self = Slider = function(config) {
  console.info('New slider with target: ' + config.target);
...
Slider.prototype = {
  ...
  init: function() {   
    ...
    self.opts.startSlide && self.goToSlide();  
  ...
  scrollMovement: function(e) {
    ...
    // console.info(wheelData, wheelData < 0)
  ...
  checkSlider: function(ele) {
    ...
    return self.moveSlider(direction);
  },
